...
X_int_train_1_5=np.load("X_int_train_1_5r.npy")
X_int_train_2_5=np.load("X_int_train_2_5r.npy")
y_train_5=np.load("y_train_5r.npy")


X_int_train_1_20=np.load("X_int_train_1_20r.npy")
X_int_train_2_20=np.load("X_int_train_2_20r.npy")
y_train_20=np.load("y_train_20r.npy")


X_int_train_1=np.load("X_int_train_1_75r.npy")
X_int_train_2=np.load("X_int_train_2_75r.npy")
y_train=np.load("y_train_75r.npy")

X_int_val_1=np.load("X_int_val_1r.npy")
X_int_val_2=np.load("X_int_val_2r.npy")
y_val=np.load("y_valr.npy")
...
np.save("result_MICNN_resample.npy",result)
