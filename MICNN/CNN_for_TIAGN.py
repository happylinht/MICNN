...
def model_fit(model,x_train_1,y_train,x_val_1,y_val,epoch=50):
    result_all=[]
    x_train_1 = x_train_1.reshape(-1,16,64,1)
    x_val_1 = x_val_1.reshape(-1,16,64,1)
...
def model_train(model):
    model,result_1 = model_fit(model,X_int_train_1_5,y_train_5,X_int_val_1,y_val,epoch=100)
    model,result_2 = model_fit(model,X_int_train_1_20,y_train_20,X_int_val_1,y_val,epoch=100)
    model,result_3 =model_fit(model,X_int_train_1,y_train,X_int_val_1,y_val,epoch=100)
