...
np.random.seed(123)
X_band_train_1, X_band_test_1, y_train, y_test = train_test_split(X_subband,y,test_size=0.25)
np.random.seed(123)
X_band_train_2, X_band_test_2, y_train, y_test = train_test_split(Feature_2,y,test_size=0.25)
...
def TIANG_band(data_1,data_2,label,sample_rate=3):     
...
X_band_train_1_5,X_band_train_2_5, y_train_5= TIANG_band(X_band_train_1,X_band_train_2, y_train,sample_rate=5)  # 设置TIANG重采样率
X_band_train_1_20,X_band_train_2_20, y_train_20= TIANG_band(X_band_train_1,X_band_train_2, y_train,sample_rate=20)  # 设置TIANG重采样率


# In[148]:


np.save("X_band_train_1_20.npy",X_band_train_1_20)
np.save("X_band_train_2_20.npy",X_band_train_2_20)
# np.save("y_train_20.npy",y_train_20)

np.save("X_band_train_1_5.npy",X_band_train_1_5)
np.save("X_band_train_2_5.npy",X_band_train_2_5)
# np.save("y_train_5.npy",y_train_5)

np.save("X_band_train_1_75.npy",X_band_train_1)
np.save("X_band_train_2_75.npy",X_band_train_2)
#np.save("y_train_75.npy",y_train)

np.save("X_band_test_1.npy",X_band_test_1)
np.save("X_band_test_2.npy",X_band_test_2)
